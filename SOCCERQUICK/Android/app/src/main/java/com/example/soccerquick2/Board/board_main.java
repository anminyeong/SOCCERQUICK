...
//툴바 + 메뉴 끝
    ...
    class BackgroundTask extends AsyncTask<Integer, Integer, Integer> { //서버로부터 게시판 목록 받아와 화면에 출력
        ...
        protected Integer doInBackground(Integer... arg0) {
            ...
            try {
                Log.e("test", "@");
                //첫번째 부분
                String query = Integer.toString(board_head);
                urlConn = getHttpURLConnection("http://52.193.2.122:3001/board/"+query, "GET", getApplicationContext());
        ...
        protected void onPostExecute(Integer a) {
            ...
            lv.setAdapter(new boardAdapter(getApplicationContext(), title, subtitle, date, header, board_id));
            Log.e("test", "@");
        }
    }
