 ...
 */
public class match_modify extends AppCompatActivity {
    ...
    Button startbtn,endbtn, datebtn, btn;
    Calendar dateTime = Calendar.getInstance();
    Calendar startTime = Calendar.getInstance();
    Calendar endTime = Calendar.getInstance();
    //id 받아오기
    String member_id, stadium, match_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_modify);
        intent = getIntent();
        match_id = intent.getExtras().getString("match_id");
        tv_title = (EditText) findViewById(R.id.match_title); //제목 받아올 text
        tv_content = (EditText) findViewById(R.id.match_content); //내용 받아올 text
...
//툴바 + 메뉴 끝
        ...
        datebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(match_modify.this, d, dateTime.get(Calendar.YEAR),
        ...
        startbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new TimePickerDialog(match_modify.this, st, startTime.get(Calendar.HOUR_OF_DAY),
        ...
        endbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new TimePickerDialog(match_modify.this, et, endTime.get(Calendar.HOUR_OF_DAY),
    ...
    class BackgroundTask1 extends AsyncTask<Integer, Integer, Integer> { //서버에 수정 된 내용 저장
        ...
        protected Integer doInBackground(Integer... arg0) {
            ...
            try {
                ...
                Log.e("test", "@");
                urlConn = getHttpURLConnection("http://52.193.2.122:3001/matchboard/update/"+match_id, "POST", getApplicationContext());
    ...
    private void updateDate() {
        datebtn = (Button) findViewById(R.id.dateBtn);
        datebtn.setText(dateFormat.format(dateTime.getTime()));
        match_date = dateFormat.format(dateTime.getTime());
    }

    private void updateStart() {
        startbtn = (Button) findViewById(R.id.startBtn);
        startbtn.setText(startFormat.format(startTime.getTime()));
        start = Integer.parseInt(startFormat.format(startTime.getTime()));
    }

    private void updateEnd() {
        endbtn = (Button) findViewById(R.id.endBtn);
        endbtn.setText(endFormat.format(endTime.getTime()));
...
//                JSONArray content_array = new JSONArray(list.getString("content"));
    ...
    class BackgroundTask3 extends AsyncTask<Integer, Integer, Integer> { //서버로부터 매치방 정보 받아와 화면에 출력
        JSONObject list = null;
        ...
        protected Integer doInBackground(Integer... arg0) {
            ...
            try {
                ...
                start = task.getInt("start_time");
                end = task.getInt("end_time");
        ...
        protected void onPostExecute(Integer a) {
            ...
            datebtn.setText(match_date);
            startbtn.setText(Integer.toString(start));
            endbtn.setText(Integer.toString(end));
        }
    }
